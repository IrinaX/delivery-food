...
/***/ "./node_modules/bootstrap.native/lib/V4/utils.js":
/*!*******************************************************!*\
  !*** ./node_modules/bootstrap.native/lib/V4/utils.js ***!
  \*******************************************************/
/*! no static exports found */
...
/* harmony import */ var bootstrap_native_dist_bootstrap_native_v4__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! bootstrap.native/dist/bootstrap-native-v4 */ "./node_modules/bootstrap.native/dist/bootstrap-native-v4.js");
/* harmony import */ var bootstrap_native_dist_bootstrap_native_v4__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(bootstrap_native_dist_bootstrap_native_v4__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var bootstrap_native_lib_V4_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! bootstrap.native/lib/V4/utils */ "./node_modules/bootstrap.native/lib/V4/utils.js");
/* harmony import */ var bootstrap_native_lib_V4_utils__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(bootstrap_native_lib_V4_utils__WEBPACK_IMPORTED_MODULE_3__);
...
smoothScrollUp.addEventListener('click', backToTop); // window.onscroll = function() {
...
var searchBlockInput = document.getElementById('search-block-input'),
...
function toggleList(marginX) {
  var skillsChecked = document.querySelectorAll('.select-skills__checkbox-item > input:checked');
...
var skillsArr = document.getElementsByName("skill");
var j, k;

for (k = 0; k < skillsArr.length; k++) {
  skillsArr[k].onclick = function (event) {
    var skillsListItems = document.querySelectorAll('.select-skills__list li');
    var marginX = selectSkillsText.offsetHeight / 2;

    if (marginX !== 0) {
      toggleList(marginX);
    } else {
      var newMargin = selectSkillsTitle.style.marginTop;
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].instances = {};
...
try {
  for (var _iterator = swipers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    var preset = swiper.dataset.preset;
    var options = void 0;
    ...
    switch (preset) {
      ...
      default:
        ...
        var loop = swiper.dataset.loop !== 'false';
        var autoplay = swiper.dataset.autoplay;
        var paginationEl = swiper.dataset.paginationel;
        var paginationType = swiper.dataset.paginationtype || 'bullets';
        var direction = swiper.dataset.direction || 'horizontal';
        var _name = swiper.dataset.name;
        var allowTouchMove = swiper.dataset.allowtouchmove !== 'false';
        var mousewheel = swiper.dataset.mousewheel ? {
          invert: false,
          releaseOnEdges: false
        } : false;
    ...
    var sw = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swiper, options);

    if (name) {
      swiper__WEBPACK_IMPORTED_MODULE_0__["default"].instances[name] = sw;
    }
  }
} catch (err) {
...
try {
  for (var _iterator2 = swipers[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    if (controlSwiper) {
      swiper__WEBPACK_IMPORTED_MODULE_0__["default"].instances[_name2].controller.control = swiper__WEBPACK_IMPORTED_MODULE_0__["default"].instances[controlSwiper];
    }
  }
} catch (err) {
